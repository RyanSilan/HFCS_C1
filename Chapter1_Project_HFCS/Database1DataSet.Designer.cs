...
namespace Chapter1_Project_HFCS {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public TableRow AddTableRow(int id, string Name, bool Client, string Job_Title) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public string Job_Title {
                get {
                    try {
                        return ((string)(this[this.tableTable.Job_TitleColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Job Title\' in table \'Table\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableTable.Job_TitleColumn] = value;
                }
            }
            ...
            public bool IsJob_TitleNull() {
                return this.IsNull(this.tableTable.Job_TitleColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetJob_TitleNull() {
                this[this.tableTable.Job_TitleColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Chapter1_Project_HFCS.Database1DataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table] WHERE (([id] = @Original_id) AND ([Name] = @Original_Name) AND ((@IsNull_Client = 1 AND [Client] IS NULL) OR ([Client] = @Original_Client)) AND ((@IsNull_Job_Title = 1 AND [Job Title] IS NULL) OR ([Job Title] = @Original_Job_Title)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([id], [Name], [Client], [Job Title]) VALUES (@id, @Nam" +
                "e, @Client, @Job_Title);\r\nSELECT id, Name, Client, [Job Title] FROM [Table] WHER" +
                "E (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [id] = @id, [Name] = @Name, [Client] = @Client, [Job Title] = @Job_Title WHERE (([id] = @Original_id) AND ([Name] = @Original_Name) AND ((@IsNull_Client = 1 AND [Client] IS NULL) OR ([Client] = @Original_Client)) AND ((@IsNull_Job_Title = 1 AND [Job Title] IS NULL) OR ([Job Title] = @Original_Job_Title)));
SELECT id, Name, Client, [Job Title] FROM [Table] WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Chapter1_Project_HFCS.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, Name, Client, [Job Title] FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_id, string Original_Name, global::System.Nullable<bool> Original_Client, string Original_Job_Title) {
            ...
            if ((Original_Client.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[3].Value = ((bool)(Original_Client.Value));
            }
            else {
        ...
        public virtual int Insert(int id, string Name, global::System.Nullable<bool> Client, string Job_Title) {
            ...
            if ((Client.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[2].Value = ((bool)(Client.Value));
            }
            else {
        ...
        public virtual int Update(int id, string Name, global::System.Nullable<bool> Client, string Job_Title, int Original_id, string Original_Name, global::System.Nullable<bool> Original_Client, string Original_Job_Title) {
            ...
            if ((Client.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[2].Value = ((bool)(Client.Value));
            }
            else {
            ...
            if ((Original_Client.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((bool)(Original_Client.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, global::System.Nullable<bool> Client, string Job_Title, int Original_id, string Original_Name, global::System.Nullable<bool> Original_Client, string Original_Job_Title) {
            return this.Update(Original_id, Name, Client, Job_Title, Original_id, Original_Name, Original_Client, Original_Job_Title);
        }
    }
